...
public class Details extends SimpleTagSupport {
    ...
    public void doTag() throws JspException, IOException {
        ...
        for(int i = 0; i < v.length; i++){
            if(i == indexMax){
                val.append("\t\t\t{y: ").append(v[i]).append(", indexLabel: '").append(highest).append("'},\n");
            }
            else if(i == indexMin){
                val.append("\t\t\t{y: ").append(v[i]).append(", indexLabel: '").append(lowest).append("'},\n");
            }
            else {
                val.append("\t\t\t{y: ").append(v[i]).append("},\n");
            }
        }
        ...
        out.println("<!DOCTYPE HTML>\n" +
                ...
                "\ttheme: \"light3\",\n" +
                "\ttitle:{\n" +
                "\t\ttext: \"Temperaturile inregistrate de-a lungul saptamanii\"\n" +
                "\t},\n" +
                "  \taxisX:{\n" +
                "      title: '" + titleX + "'\n" +
                "    },\n" +
